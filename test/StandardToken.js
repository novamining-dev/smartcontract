...
var StandardTokenMock = artifacts.require('../contracts/helpers/StandardTokenMock.sol');
...
contract('StandardToken', function(accounts) {
  ...
  it('should increase by 50 then set to 0 when decreasing by more than 50', async function() {
    ...
    let postDecrease = await token.allowance(accounts[0], accounts[1]);
    //console.log(postDecrease)
    assert(postDecrease.equals(0));
    //postDecrease.should.be.bignumber.equals(0);
